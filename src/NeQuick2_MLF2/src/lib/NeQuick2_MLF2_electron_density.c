/** NeQuick2-MLF2 electron density computation
 *
...
static void bottom_side_get_B_params(
  ...
  const NeQuick2_MLF2_iono_profile_t* const pProfile,
...
static double_t top_side(
  ...
  return (NEQUICK_2_MLF2_IONO_LAYER_GET_PEAK_AMPLITUDE(temp) *
          pProfile->F2.layer.peak.electron_density);
}

double_t NeQuick2_MLF2_electron_density_get(
  NeQuick2_MLF2_iono_profile_t* const pProfile,
  const double_t height_km) {
