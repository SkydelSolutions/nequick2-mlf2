 ...
 * @file
 */
#ifndef NEQUICK2_MLF2_GAUSS_KRONROD_INTEGRATION_H
#define NEQUICK2_MLF2_GAUSS_KRONROD_INTEGRATION_H
...
typedef struct NeQuick2_MLF2_gauss_kronrod_context_st {
...
} NeQuick2_MLF2_gauss_kronrod_context_t;
 ...
 */
extern int32_t NeQuick2_MLF2_Gauss_Kronrod_integrate(
  NeQuick2_MLF2_gauss_kronrod_context_t* const pGauss_kronrod,
  NeQuick2_MLF2_context_t* const pContext,
  const double_t point_1_height_km,
  const double_t point_2_height_km,
  double_t* const pTEC);

#endif // NEQUICK2_MLF2_GAUSS_KRONROD_INTEGRATION_H
