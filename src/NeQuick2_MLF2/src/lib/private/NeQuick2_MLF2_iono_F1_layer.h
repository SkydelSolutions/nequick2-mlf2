/** NeQuick2-MLF2 F1 layer profile
 *
 ...
 * @file
 */
#ifndef NEQUICK2_MLF2_IONO_F1_LAYER_H
#define NEQUICK2_MLF2_IONO_F1_LAYER_H
...
#define NEQUICK_2_MLF2_IONO_F1_LAYER_AMPLITUDE_CONSTANT (0.8)
 ...
 */
#define NEQUICK_2_MLF2_F1_LAYER_IS_PEAK_PRESENT(_F1) \
 ...
 *
 */
extern void NeQuick2_MLF2_F1_layer_get_critical_freq_MHz(
  layer_t* const pF1,
 ...
 */
extern void NeQuick2_MLF2_F1_layer_get_peak_height(
  layer_t* const pF1,
 ...
 * @param[in] F2_peak_height_km F2 layer maximum density height
 */
extern void NeQuick2_MLF2_F1_layer_get_peak_thickness(
  layer_t* const pF1,
  const double_t E_peak_height_km,
  const double_t F2_peak_height_km);

#endif // NEQUICK2_MLF2_IONO_F1_LAYER_H
