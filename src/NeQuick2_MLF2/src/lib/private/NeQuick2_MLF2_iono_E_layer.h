 ...
 * @file
 */
#ifndef NEQUICK2_MLF2_IONO_E_LAYER_H
#define NEQUICK2_MLF2_IONO_E_LAYER_H
 ...
 */
#define NEQUICK_2_MLF2_IONO_E_LAYER_CRITICAL_FREQUENCY_NEGLIGIBLE (1.0e-30)
 ...
 */
#define NEQUICK_2_MLF2_IONO_E_LAYER_INFLUENCES_F2_PEAK_HEIGHT(_crit_freq_MHz) \
(_crit_freq_MHz >=  \
  NEQUICK_2_MLF2_IONO_E_LAYER_CRITICAL_FREQUENCY_NEGLIGIBLE)

/** Constant used to calculate E layer amplitude. Eq 98 */
#define NEQUICK_2_MLF2_IONO_E_LAYER_AMPLITUDE_CONSTANT_1 (5.0e-2)
/** Constant used to calculate E layer amplitude. Eq 98 */
#define NEQUICK_2_MLF2_IONO_E_LAYER_AMPLITUDE_WITH_TRANSITION_REGION \
(60.0)
/** Constant used to calculate E layer amplitude. Eq 98 */
#define NEQUICK_2_MLF2_IONO_E_LAYER_AMPLITUDE_CONSTANT_2 (5.0e-3)

/** E layer profile context */
typedef struct NeQuick2_MLF2_E_layer_st {
 ...
 */
extern void NeQuick2_MLF2_E_layer_get_critical_freq_MHz(
  NeQuick2_MLF2_E_layer_t* const pE,
 ...
 * @param[in, out] pE E layer profile context
 */
extern void NeQuick2_MLF2_E_layer_get_peak_height(
  NeQuick2_MLF2_E_layer_t* const pE);
 ...
 */
extern void NeQuick2_MLF2_E_layer_get_peak_thickness(
  NeQuick2_MLF2_E_layer_t* const pE,
  const double_t F1_peak_thickness_bottom_km);

#endif // NEQUICK2_MLF2_IONO_E_LAYER_H
