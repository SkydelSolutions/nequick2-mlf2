/** NeQuick2-MLF2 electron density
 *
 ...
 * @file
 */
#ifndef NEQUICK2_MLF2_ELECTRON_DENSITY_H
#define NEQUICK2_MLF2_ELECTRON_DENSITY_H
 ...
 */
extern double_t NeQuick2_MLF2_electron_density_get(
  NeQuick2_MLF2_iono_profile_t* const pProfile,
  const double_t height_km);

#endif // NEQUICK2_MLF2_ELECTRON_DENSITY_H
