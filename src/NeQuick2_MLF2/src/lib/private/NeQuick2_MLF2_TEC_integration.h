/** NeQuick2-MLF2 Total Electron Content (TEC) integration routine<br>
 *
 ...
 * @file
 */
#ifndef NEQUICK2_MLF2_TEC_INTEGRATION_H
#define NEQUICK2_MLF2_TEC_INTEGRATION_H
 ...
 */
extern int32_t NeQuick2_MLF2_integrate(
  NeQuick2_MLF2_context_t* const pContext,
  double_t* const pTEC);

#endif // NEQUICK2_MLF2_TEC_INTEGRATION_H
