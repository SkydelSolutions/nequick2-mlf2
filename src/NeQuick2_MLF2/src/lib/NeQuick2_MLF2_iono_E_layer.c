...
static double_t get_seasonal_parameter(
  ...
  switch (pTime->month) {
  case NEQUICK_2_MLF2_MONTH_JANUARY:
  case NEQUICK_2_MLF2_MONTH_FEBRUARY:
  case NEQUICK_2_MLF2_MONTH_NOVEMBER:
  case NEQUICK_2_MLF2_MONTH_DECEMBER:
    return -1.0;
  case NEQUICK_2_MLF2_MONTH_MARCH:
  case NEQUICK_2_MLF2_MONTH_APRIL:
  case NEQUICK_2_MLF2_MONTH_SEPTEMBER:
  case NEQUICK_2_MLF2_MONTH_OCTOBER:
    return 0.0;
  case NEQUICK_2_MLF2_MONTH_MAY:
  case NEQUICK_2_MLF2_MONTH_JUNE:
  case NEQUICK_2_MLF2_MONTH_JULY:
  case NEQUICK_2_MLF2_MONTH_AUGUST:
    return 1.0;
  default:
...
void NeQuick2_MLF2_E_layer_get_critical_freq_MHz(
  NeQuick2_MLF2_E_layer_t* const pLayer,
  const NeQuick2_MLF2_time_t* const pTime,
  ...
  double_t solar_effective_angle_degree;
  {
    if (!pLayer->is_solar_declination_valid) {
      pLayer->solar_declination = NeQuick2_MLF2_solar_get_declination(pTime);
    }

    solar_effective_angle_degree =
      NeQuick2_MLF2_solar_get_effective_zenith_angle(
  ...
  double_t critical_freq =
    (NEQUICK_G_JRC_IONO_E_LAYER_CONSTANT_1 -
     ...
     sqrt(sqrt(pSolar_activity->solar_radio_flux_sfu));
  ...
  pLayer->layer.peak.electron_density =
    NEQUICK_2_MLF2_IONO_GET_e_DENSITY(pLayer->layer.critical_frequency_MHz);
}

void NeQuick2_MLF2_E_layer_get_peak_height(NeQuick2_MLF2_E_layer_t* const pLayer) {
  pLayer->layer.peak.height_km =
    NEQUICK_G_JRC_IONO_E_LAYER_MAX_e_DENSITY_HEIGHT_KM;
}

void NeQuick2_MLF2_E_layer_get_peak_thickness(
  NeQuick2_MLF2_E_layer_t* const pE,
...
void NeQuick2_MLF2_E_layer_init(NeQuick2_MLF2_E_layer_t* const pE) {
