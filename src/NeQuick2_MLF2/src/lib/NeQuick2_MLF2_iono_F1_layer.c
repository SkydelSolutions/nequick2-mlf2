...
void NeQuick2_MLF2_F1_layer_get_critical_freq_MHz(
  ...
  pLayer->peak.electron_density =
    NEQUICK_2_MLF2_IONO_GET_e_DENSITY(pLayer->critical_frequency_MHz);
}

void NeQuick2_MLF2_F1_layer_get_peak_height(
  layer_t* const pLayer,
...
void NeQuick2_MLF2_F1_layer_get_peak_thickness(
  layer_t* const pF1,
  const double_t E_peak_height_km,
  const double_t F2_peak_height_km) {
